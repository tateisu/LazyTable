...
| 目標            | 困難                                                            | 対策                                                                                                                                        |
|---------------|---------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------|
| 大量のセルの事前サイズ計測 | Composeで行うのは非常に困難。<br>ベタに書くとメモリ消費が非現実的                        | 事前計測部分だけViewフレームワークを使う。<br>テキスト計測結果をComposeと揃えるため`androidx.compose.ui.text.Paragraph`を使う<br>カスタムビューという~~けったいな~~モノを用意。<br>`AnnotatedString`には対応できていない |
